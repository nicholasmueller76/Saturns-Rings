...
Alternatively, running `python main.py .. saturns_rings.p8 main.lua` while the PICO-8 sticher folder is the current working directory in a terminal instance will compile the cart.
